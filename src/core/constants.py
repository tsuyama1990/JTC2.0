...
DEFAULT_MIN_CONTENT_LENGTH: Final[int] = 3
DEFAULT_MAX_CONTENT_LENGTH: Final[int] = 1000
DEFAULT_MIN_LIST_LENGTH: Final[int] = 1
DEFAULT_MAX_LIST_LENGTH: Final[int] = 20
DEFAULT_MAX_CUSTOM_METRICS: Final[int] = 50
DEFAULT_MIN_METRIC_VALUE: Final[float] = 0.0
DEFAULT_MAX_PERCENTAGE_VALUE: Final[float] = 100.0
